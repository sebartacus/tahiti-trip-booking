...
export async function GET(request: Request) {
  ...
  try {
    ...
    const [pecheReservations, pecheRights, baleinesReservations, baleinesRights] = await Promise.all([
      ...
      supabase.from("salon_peche_rights").select("id,status,reservation_id,offer_type,formule,nombre_personnes,valid_until,public_code"),
      ...
      supabase.from("salon_baleines_rights").select("id,status,reservation_id,composition,valid_until,public_code"),
    ]);

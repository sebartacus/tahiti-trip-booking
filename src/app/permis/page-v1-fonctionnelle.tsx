...
function verifierAvantPaiement() {
  if (!prenom.trim()) {
...
{paiementValide && (
  <div className="mt-6 bg-green-100 text-green-900 rounded-2xl p-6">
    ...
    <ul className="list-disc ml-6 space-y-1">
      ...
      {formule === "Classique" && (
        <li>
          Timbres fiscaux à déposer directement auprès de Tahiti Trip Fishing
        </li>
      )}
    </ul>
    ...
    {formule === "Sérénité" && (
      <p className="mt-4">
        Les timbres fiscaux sont pris en charge par Tahiti Trip Fishing.
      </p>
    )}

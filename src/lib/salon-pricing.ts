export const SALON_PRICING = {
  ...
  baleines: {
    miseEau: { offerCode: "baleines_mise_eau", salon: 12_500, normal: 15_000 },
    observateur: {
      offerCode: "baleines_observateur",
      salon: 8_500,
      normal: 8_500,
    },
    enfantMoinsDouze: {
      offerCode: "baleines_enfant_moins_12",
      salon: 7_000,
      normal: 7_000,
    },
    enfantMoinsCinq: { offerCode: "baleines_enfant_moins_5", salon: 0 },
    groupe: {
      offerCode: "baleines_5_plus_1",
      placesPayees: 5,
      placesTotales: 6,
      total: 62_500,
      normal: 90_000,
    },
    validiteOffres: "20 novembre 2026",
    carnets: [
      {
        offerCode: "carnet_baleines_5",
        sorties: 5,
        total: 55_000,
        normal: 65_000,
        parSortie: 11_000,
